	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h1 style="text-align: center; font-size: 60px">Sell Your Site</h1>
...
<div class="container">
   ...
   <div class="account-type col-3">
			<div>
				<input class="account-type-radio" type="checkbox" name="monetization[]" id="{{$item->name}}" value="{{$item->id}}"/>
   ...
   <div class="account-type col-3">
			<div>
				<input class="account-type-radio" type="radio" name="industry_id" id="{{$item->name}}" value="{{$item->id}}"/>
				<label for="{{$item->name}}" class="ripple-effect-dark">{{$item->name}}</label>
			</div>
    </div>
	@endforeach
    ...
    <abc>
		...
		<div class="row">
			...
			<div class="col-xl-6">
					...
					<input type="date" name="making_money">
				</div>
			</div>						
		<div class="row">
			<div class="col-xl-12">
				<div class="keyword-input-container" >
				<input type="url" class="keyword-input" placeholder="Add URL" name="url[]"/>
    ...
    <abc>
							...
							<input placeholder="$ 0.00" name="quater_profit" type="number">
						</div>	
							...
							<input placeholder="$ 0.00" name="annual_profit" type="number">
						</div>	
							...
							<input placeholder="$ 0.00" name="biannual_profit" type="number">
						</div>	
						<br><br>	<br><br>				
						</div>
...
<div id="myresult">
  ...
  <h3>Extra Information</h3>
    <abc>
		...
		<textarea name="description" placeholder="Challenges, need to know things, business success and profile or anything related to listing." height="6rem" class="TextArea__TextareaStyled-ekrhIz ekDYrB" required></textarea>

	</div>
	<div class="col-6">
		<span>Work & Skills Required</span>

		<textarea name="skill_required" placeholder="Skill Required to operate this business" height="6rem" class="TextArea__TextareaStyled-ekrhIz ekDYrB" required></textarea>
</div>
<div class="col-6">
    	    	<span>Assets Included in the Sale</span>

			
		<textarea name="assets" placeholder="What assets this sale will include" height="6rem" class="TextArea__TextareaStyled-ekrhIz ekDYrB" required></textarea>

	</div>	
<div class="col-6">
		<span>How Much Work per Week Required? (in Hours)</span>
		<!-- maximum work in a week is 168 = 24 hrs x 7 days -->
		<input type="number" min="0" class="form-control" name="work_per_week" value="20" max="168" required>
</div>
<div class="col-3">
		<span>Private Blog Network (PBN)</span>
		<input type="checkbox" value="true" class="form-control" name="pbn"> 
</div>
<div class="col-3">
		<span>Platform</span>
		<input type="text" min="0" class="form-control" name="platform" placeholder="Platform (if applicable)">
</div>
<div class="col-3"></div>
</div>		
...
onFinished: function(event) {
	...
	var suc_func = function(msg) {
		...
		Swal.fire(
        'Great !',
        'Your listing created successfully , Kindly wait for the approval',
        'success' 
       );
